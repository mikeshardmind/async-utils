...
__all__ = ("corocache", "get_stats", "lrucorocache", "reset_stats")
...
def corocache[**P, R](
    ...
    *,
    ...
    def wrapper(coro: CoroLike[P, R]) -> CoroFunc[P, R]:
        ...
        wrapped.hits = MethodType(hits, wrapped)  # pyright: ignore[reportFunctionMemberAccess]
        wrapped.misses = MethodType(misses, wrapped)  # pyright: ignore[reportFunctionMemberAccess]
        wrapped.reset_stats = MethodType(reset_stats, wrapped)  # pyright: ignore[reportFunctionMemberAccess]
