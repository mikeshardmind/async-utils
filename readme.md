...
| [dual_color.py](src/async_utils/dual_color.py)         | Contains thread-safe queues with both sync and async colored access.                 | Missing docs                                                                                                                                                             |
...
| [task_cache.py](src/async_utils/task_cache.py)         | task-based decorators for preemptive async caching.                                                              | This pulls in inspect, see [`corofunc_cache.py`](src/async_utils/corofunc_cache.py) for a lighter weight alternative if you don't need direct access to the lower level task objects. |
